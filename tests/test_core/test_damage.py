...
class TestDamageFilter:
    ...
    def test_should_filter_ct_5prime(self) -> None:
        ...
        assert (
            df.should_filter(
                position=100, ref="C", alt="T", read_position=0, read_length=100, is_reverse=False
            )
            is True
        )
        ...
        assert (
            df.should_filter(
                position=101, ref="C", alt="T", read_position=1, read_length=100, is_reverse=False
            )
            is True
        )
        ...
        assert (
            df.should_filter(
                position=150, ref="C", alt="T", read_position=50, read_length=100, is_reverse=False
            )
            is False
        )
    ...
    def test_should_filter_ga_3prime(self) -> None:
        ...
        assert (
            df.should_filter(
                position=100, ref="G", alt="A", read_position=99, read_length=100, is_reverse=False
            )
            is True
        )
        ...
        assert (
            df.should_filter(
                position=100, ref="G", alt="A", read_position=50, read_length=100, is_reverse=False
            )
            is False
        )
    ...
    def test_should_filter_reverse_strand(self) -> None:
        ...
        assert (
            df.should_filter(
                position=100, ref="C", alt="T", read_position=99, read_length=100, is_reverse=True
            )
            is True
        )
        ...
        assert (
            df.should_filter(
                position=100, ref="G", alt="A", read_position=0, read_length=100, is_reverse=True
            )
            is True
        )
    ...
    def test_should_filter_non_damage(self) -> None:
        ...
        assert (
            df.should_filter(
                position=100, ref="A", alt="G", read_position=0, read_length=100, is_reverse=False
            )
            is False
        )
...
class TestDamageFilterProfile:
    ...
    def test_filter_profile_with_damage_markers(self) -> None:
        ...
        obs = AlleleObservation(position=100, ref_allele="C", alleles={"T": 1.0}, source="test")
